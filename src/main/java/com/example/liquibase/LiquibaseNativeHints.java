 ...
 */
@Slf4j
public class LiquibaseNativeHints implements NativeConfiguration {
    ...
    public void computeHints(NativeConfigurationRegistry registry, AotOptions aotOptions) {
        ...
        compositeTypes.addAll(Arrays.stream(this.typeNames)
                .map( LiquibaseNativeHints::classForName).collect(Collectors.toSet()));
